...
INSERT INTO tablas (idtabla,idelemento,nombre,dato1) VALUES ('prezzta','apertura_prestamo_1','datos para aperturar el prestamo','30312');

DELETE FROM tablas WHERE idtabla = 'prezzta' and idelemento = 'apertura_prestamo_2';
INSERT INTO tablas (idtabla,idelemento,nombre,dato1) VALUES ('prezzta','apertura_prestamo_2','datos para aperturar el prestamo complemento','30312');
...
INSERT INTO tablas (idtabla,idelemento,nombre,dato2) VALUES ('prezzta','concepto_poliza','Concepto de la poliza','Prestamo solicitado por el socio en linea y autorizado');
...
INSERT INTO tablas (idtabla,idelemento,nombre,dato1) VALUES ('prezzta','producto_comision','Producto a donde se abonara la comision','0');
...
INSERT INTO tablas (idtabla,idelemento,nombre,dato2) VALUES ('prezzta','texto_sms_dispersion','texto sms para dispersion','Se ha depositado a tarjeta de debito un total de @monto@ por concepto de solictud de prestamo');
...
INSERT INTO tablas (idtabla,idelemento,dato1) VALUES ('prezzta','usuario','9999');
...
insert into tablas(idtabla,idelemento,dato1,dato2,dato3) values('prezzta','horario_actividad','08:00','22:00','0|1|2|3|4|5|6');
