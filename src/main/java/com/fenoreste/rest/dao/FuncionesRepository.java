...
public interface FuncionesRepository extends JpaRepository<Persona,Integer>{
	...
	@Query(value = "SELECT * FROM sai_prezzta_devuelve_condiciones_apertura_2(?1, ?2, ?3)", nativeQuery = true)
	public String monto_a_prestar_2(Integer idorigen, Integer idgrupo, Integer idsocio);
