...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory",transactionManagerRef = "TransactionManager",basePackages = "com.fenoreste.rest.dao")
public class SpringConfiguration {	
	...
	public LocalContainerEntityManagerFactoryBean entity(){
		...
		em.setPackagesToScan("com.fenoreste.rest.entity");		
