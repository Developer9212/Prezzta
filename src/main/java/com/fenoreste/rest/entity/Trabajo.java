...
public class Trabajo implements Serializable {
	...
	public String toString() {
		return "Trabajo [idorigen=" + idorigen + ", idgrupo=" + idgrupo + ", idsocio=" + idsocio + ", nombre=" + nombre
				+ ", calle=" + calle + ", numero=" + numero + ", idcolonia=" + idcolonia + ", telefono=" + telefono
				+ ", telefono2=" + telefono2 + ", ocupacion=" + ocupacion + ", fechaingreso=" + fechaingreso
				+ ", puesto=" + puesto + ", entrecalles=" + entrecalles + ", tipo_empleo=" + tipo_empleo
				+ ", sector_laboral=" + sector_laboral + ", giro_empresa=" + giro_empresa + ", forma_comprobar_ing="
				+ forma_comprobar_ing + ", consecutivo=" + consecutivo + ", fechasalida=" + fechasalida
				+ ", ing_mensual_bruto=" + ing_mensual_bruto + ", ing_mensual_neto=" + ing_mensual_neto
				+ ", frecuencia_ingresos=" + frecuencia_ingresos + ", tipo_ocupacion=" + tipo_ocupacion
				+ ", num_empleados=" + num_empleados + ", num_taxis=" + num_taxis + ", deducciones_deudas="
				+ deducciones_deudas + ", deducciones_otros=" + deducciones_otros + ", actividad_economica="
				+ actividad_economica + ", ocupacion_numero=" + ocupacion_numero + ", actividad_economica_pld="
				+ actividad_economica_pld + ", ext_tel_1=" + ext_tel_1 + ", ext_tel_2=" + ext_tel_2 + "]";
	}
